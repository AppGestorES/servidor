...
const postUsuariosService: string =
    "INSERT INTO usuarios (nombre, apellido, contrasena, identificador, id_proyecto) VALUES (?, ?, ?, ?, ?)";

const putUsuariosService: string =
    "UPDATE usuarios SET nombre = ?, apellido = ?, foto = ?, contrasena = ?, identificador = ?, id_proyecto = ? WHERE id = ?";
