...
router.get("/proveedores/nombre/:nombre", new Proveedores().getProveedoresByNombre);
router.get("/proveedores/proyecto/:id_proyecto", new Proveedores().getProveedoresByProyecto);
