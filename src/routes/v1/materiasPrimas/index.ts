...
router.get(
    "/materias_primas/nombre/:nombre",
    new MateriasPrimas().getMateriasPrimasByNombre
);
router.get(
    "/materias_primas/proyecto/:id_proyecto",
    new MateriasPrimas().getMateriasPrimasByProyecto
);
...
router.delete(
    "/materias_primas/:id",
    new MateriasPrimas().deleteMateriasPrimas
);
