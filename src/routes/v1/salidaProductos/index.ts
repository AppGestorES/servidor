...
router.get(
    "/salidas/producto_final/:producto_final_id",
    new SalidaProductos().getSalidasByProductoFinal
);
router.get(
    "/salidas/fecha_salida/:fecha_salida",
    new SalidaProductos().getSalidasByFechaSalida
);
router.get(
    "/salidas/proyecto/:id_proyecto",
    new SalidaProductos().getSalidasByProyecto
);
